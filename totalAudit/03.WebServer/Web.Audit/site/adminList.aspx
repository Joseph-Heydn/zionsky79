<%@ Page
	...
	Inherits="Web.Audit.site.adminList"
%>
...
<asp:Content ContentPlaceHolderId="contents" runat="server">
	<div class="box col-md-6" style="width:620px; margin-top:0; display:inline-block;">
		<!-- 관리자 목록 -->
		<div class="box-inner">
			<div class="box-header well" data-original-title="">
				...
				<div style="display:inline-block; float:right;">
					...
					<asp:Button OnClick="btnSearch_OnClick" CssClass="cButton" runat="server" meta:resourcekey="sh_btn_Search"/>
			...
			<div class="box-content">
				<table class="table table-bordered" style="border-collapse:collapse; border:1px; width:100%; font-size:9pt;">
					<tr class="table table-bordered" style="background-color:#e9e9e9; font-weight:bold; text-align:center;">
						...
						<td style="width:120px;"><asp:Literal EnableViewState="False" runat="server" meta:resourcekey="dg_AdminId" /></td>
						<td style="width:140px;"><asp:Literal EnableViewState="False" runat="server" meta:resourcekey="dg_AdminNm" /></td>
...
<asp:Repeater id="repAdminList" OnItemCommand="repAdminList_OnItemCommand" runat="server">
	<ItemTemplate>
					<tr id="m<%# Eval("cAdminNo") %>" class="<%= fnRowStyle() %>" style="text-align:center;">
						...
						<td>
							<asp:LinkButton CommandName="SELECT" runat="server">
								<asp:Literal id="cAdminName" Text='<%# Eval("cAdminName") %>' runat="server" />
							</asp:LinkButton>
						</td>
						<td>
	...
	<div class="box col-md-6" style="width:555px; margin-top:0; display:inline-block;">
		<div class="box-inner">
			<!-- 관리자 기본정보 -->
			<div class="box-header well" data-original-title="">
				<h2>
			...
			<div class="box-content">
				<table class="table table-bordered" style="width:500px; font-size:9pt;">
					<tr>
