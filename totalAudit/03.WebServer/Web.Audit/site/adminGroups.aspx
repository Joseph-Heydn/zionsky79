<%@ Page
	...
	Inherits="Web.Audit.site.adminGroups"
%>
...
<asp:Content ContentPlaceHolderId="cpContents" runat="server">
	<div class="box col-md-6" style="width:480px; margin-top:0; display:inline-block;">
		<!-- 그룹목록 -->
		<div class="box-inner">
...
<asp:Repeater id="repGroupList" OnItemCommand="repGroupList_OnItemCommand" runat="server">
	...
	<div id="panelGroupInfo" Visible="False" style="width:700px; margin-top:0; display:inline-block;" runat="server">
		...
		<!-- 구성원 관리 -->
		<div class="box col-md-6" style="width:752px; margin-top:0;">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-list-alt"></i>
				...
				<div class="box-content">
					<!-- 비 구성원 -->
					<div style="width:345px; border:1px solid #ccc; background-color:#cccccc; display:inline-block; text-align:center;">
						...
						<div style="width:345px; height:180px; overflow-y:scroll; overflow-x:hidden; background-color:#ffffff; border-color:#cccccc;" onmouseover="document.body.style.overflow='hidden'" onmouseout="document.body.style.overflow='auto'">
							<table class="table table-bordered" style="border-collapse:collapse; border:1px; width:100%; font-size:9pt;">
								<tr class="table table-bordered" style="background-color:#e9e9e9; font-weight:bold; text-align:center;">
									<td style="width:030px;"><asp:CheckBox id="chkAdminLeft" onclick="fnCheckAll(this,'cBlank');" EnableViewState="False" runat="server" /></td>
									<td style="width:100px;"><asp:Literal runat="server" meta:resourcekey="dg2_admin_id" /></td>
									<td style="width:100px;"><asp:Literal runat="server" meta:resourcekey="dg2_admin_nm" /></td>
...
<asp:Repeater id="repAdminRight" runat="server">
	<ItemTemplate>
		...
		<!-- 메뉴권한 관리 -->
		<div class="box col-md-6" style="width:752px;">
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-list-alt"></i>
				...
				<div class="box-content">
					...
					<div style="width:345px; border:1px solid #ccc; background-color:#cccccc; display:inline-block; text-align:center;">
						...
						<div style="width:345px; height:350px; overflow-y:scroll; overflow-x:hidden; background-color:#ffffff; border-color:#cccccc;" onmouseover="document.body.style.overflow='hidden'" onmouseout="document.body.style.overflow='auto'">
							<table class="table table-bordered" style="border-collapse:collapse; border:1px; width:100%; font-size:9pt;">
								<tr class="table table-bordered" style="background-color:#e9e9e9; font-weight:bold; text-align:center;">
