...
<form method="post" runat="server">
	<div class="login-box">
		<div class="login-logo">
			<b><asp:Literal runat="server" meta:resourcekey="lbl_Title_01"/></b>
			<asp:Literal runat="server" meta:resourcekey="lbl_Title_02"/>
			<asp:HiddenField id="pReturnUrl" runat="server"/>
			<asp:HiddenField id="pListUrl" runat="server"/>
		</div>
		<!-- /.login-logo -->

		<div class="login-box-body">
			<p class="login-box-msg">
				<asp:Literal runat="server" meta:resourcekey="lbl_info_text"/>
			</p>
			<div class="form-group has-feedback">
				<asp:TextBox id="txtAccountId" TextMode="Email" class="form-control" runat="server" meta:resourcekey="lbl_account"/>
				<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
			</div>
			<div class="form-group has-feedback">
				<asp:TextBox id="txtPassword" TextMode="Password" class="form-control" runat="server" meta:resourcekey="lbl_password"/>
				...
				<div class="col-xs-8">
					<div class="checkbox icheck">
						<label>
							...
							<asp:Literal runat="server" meta:resourcekey="lbl_remember"/>
						</label>
					</div>
				</div><!-- /.col -->
				<div class="col-xs-4">
					<asp:Button OnClick="btnLogin_Click" OnClientClick="fnSaveAccount();" class="btn btn-primary btn-block btn-flat" runat="server" meta:resourcekey="lbl_signIn"/>
				</div><!-- /.col -->
			</div>

			<a href="#">
				<asp:Literal runat="server" meta:resourcekey="lbl_forgot"/>
			</a><br>
			<a href="/register.aspx" class="text-center">
				<asp:Literal runat="server" meta:resourcekey="lbl_register"/>
			</a>
		</div>
		<!-- /.login-box-body -->
	</div>
