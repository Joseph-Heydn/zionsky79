<%@ Page
	...
	Inherits="Web.Manage.site.menuList"
%>
			...
			<div class="box">
				<div class="box-header">
					...
					<div style="display:inline-block; float:right;">
						...
						<asp:Button OnClick="btnSearch_OnClick" CssClass="btn-xs" runat="server" meta:resourcekey="btn_Search"/>
				...
				<div class="box-content">
					...
					<table class="table table-bordered" style="border-collapse:collapse; border:1px; width:100%; font-size:9pt;">
						<tr class="table table-bordered" style="background-color:#e9e9e9; font-weight:bold; text-align:center;">
							...
							<td style="width:100px;"><asp:Literal EnableViewState="False" runat="server" meta:resourcekey="dg_menu_grp_nm"/></td>
			...
			<div class="box">
				<div class="box-header">
					...
					<div style="display:inline-block; float:right; padding-bottom:3px;">
						<asp:Button OnClick="btnNew_OnClick" CssClass="btn-xs" runat="server" meta:resourcekey="btn_New"/>&nbsp;
						<asp:Button OnClick="btnSave_OnClick" CssClass="btn-xs" runat="server" meta:resourcekey="btn_Save"/>
					</div>
				</div>
				<div class="box-content">
					<table class="table table-bordered" style="width:100%;">
						...
						<tr>
							...
							<td class="tbLayout"><asp:TextBox id="txtExecUrl" Width="100%" style="text-align:left;" runat="server"/></td>
						</tr>
						<tr>
							<td class="tbLayoutHeader" style="height:25px;">
						...
						<tr>
							...
							<td class="tbLayout"><asp:TextBox id="txtNoteDesc" Width="100%" Height="70px" TextMode="MultiLine" MaxLength="200" runat="server"/></td>
						</tr>
					</table>
				</div>
			</div>
