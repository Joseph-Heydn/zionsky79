<% @ Language=VBScript %>
<% Option Explicit %>
<!-- #include file="CAPTCHA_configuration.asp" --> 
<%
'****************************************************************************************
'**  Copyright Notice    
'**
...
For intLoop = 0 To 4
	...
	Session("strSecurityCode") = strCAPTCHAcode
