...
namespace _12sky2.web.include
{
    public partial class left : System.Web.UI.UserControl
    {
        ...
        public string setTITL { set { TITL = value; } }

        public string SUB_TITL = string.Empty;
        public string setSUB_TITL { set { SUB_TITL = value; } }
        ...
        private void setMenu()
        {
            try
            {
                ...
                string menuHTML = "";
                ArrayList menu = MENU.getMenu(TITL);
                ...
                for (int i = 0; i < menu.Count; i++)
                {
                    ...
                    if (_menu[0].Trim().Equals(SUB_TITL)) _class = "class='on'";
