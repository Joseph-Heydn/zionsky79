<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="upgrading.aspx.cs" Inherits="_12sky2.web.shop.upgrading" %>
            ...
            <div id="wrap">
                ...
                <div id="C_container">
			        ...
			        <div class="lnb">
				        ...
				        <div class="left_menu">
					        <ul>
						        <li><a href="/web/shop/upgrading.aspx" class="on">รายการสินค้า</a></li>
						        <asp:Panel ID="LEFT_MENU_LIST" runat="server" Visible="false">
						        <li><a href='<%=GETBILLURL()%>/FillUp/PaymentMain.aspx'>เงินสด</a>
						            <ul>
								        <li><a href='<%=GETBILLURL()%>/FillUp/PaymentMain.aspx'>ซื้อเหรียญGP</a></li>
								        <li><a href='<%=GETBILLURL()%>/History/FillUpHistory.aspx'>กรอกประวัติ</a></li>
                                        <li><a href='<%=GETBILLURL()%>/History/PurchaseHistory.aspx'>ประวัติการซื้อ</a></li>
								        <li><a href='<%=GETBILLURL()%>/Policy/CoinsPolicy.aspx'>นโยบายเหรียญ</a></li>
							        </ul>
							    </li>
						        </asp:Panel>
					        </ul>
...
<%--
			        ...
			        <div id="contents">
                    	<div class="con_top">
					        <div class="nav_hint">Home &gt; Shop &gt; รายการสินค้า &gt; <span class="now">Upgrading</span></div>
					        <div class="page_tit">รายการสินค้า</div>
				        </div>
				        ...
				        <div class="content_page">
					        <div class="page_tab">
						        <div class="tab">
							        <ul>
								        <li class="on"><a href="/web/shop/upgrading.aspx">Upgrading</a></li>
								        <li><a href="/web/shop/buffs.aspx">Buffs</a></li>
								        <li><a href="/web/shop/vanity.aspx">Vanity</a></li>
								        <li><a href="/web/shop/miscellaeous.aspx">Miscellaeous</a></li>
							        </ul>
						        </div>
					        </div>	
                            ...
                            <div class="con_table">                                                          
						        <table cellspacing="0" cellpadding="0" class="I_table">
							        ...
							        <tbody>
								        ...
								        <tr>
									        <th class="center" colspan="3">คำอธิบาย</th>
								        </tr>
								        <tr>
