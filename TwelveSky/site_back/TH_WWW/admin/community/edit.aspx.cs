    ...
    public partial class edit : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                T_COMMUNITY_BORD.update(Request.QueryString["DIV"].ToString(), Request.QueryString["SEQ"].ToString(), _title.Value, tmpCntn, Session["USER_ID"].ToString(), Session["USER_NICK_NM"].ToString(), "N", FILE_SEQ.Value.Split(new char[] { ',' }), DEL_FILE_SEQ.Value.Split(new char[] { ',' }));
