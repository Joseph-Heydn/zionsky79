						...
						<div class="right_login">
							<div class="login_input">
								...
								<ul class="input_box">
									...
									<li class="forget"><a href="/web/mypage/findid.aspx">ลืมIDหรือระหัสผ่าน?</a></li>
								</ul>
								<ul class="login_btn">
									<li>
								...
								<asp:Panel ID="USER_PAGE" runat="server" Visible="false">
										<ul class="input_box">
											...
											<li class="logout">
												<a href="#" onclick="if(confirm('คุณแน่ใจว่าจะออกจากระบบ?')) { __doPostBack('btn_logout',''); }">Logout</a>
								...
								<ul>
									...
									<li>
										...
										<asp:Panel ID="DOWN2" runat="server" Visible="false">
											<a href="#" onclick="alert('กรุณาเข้าสู่ระบบก่อนที่จะดาวน์โหลดไคลเอนต์');$('#ID').focus();"><img src="/resources/images/img/download_btn.png" alt="game download" /></a>
										</asp:Panel>
									</li>
								</ul>
							</div>
