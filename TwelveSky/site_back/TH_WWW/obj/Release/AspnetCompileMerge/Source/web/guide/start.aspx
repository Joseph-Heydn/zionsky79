        ...
        <div id="main_bg">
            <div id="wrap">
		        ...
		        <div id="C_container">
			        ...
			        <div id="contents">
				        <div class="con_top">
					        <div class="nav_hint">Home &gt; แนะนำเกม &gt; <span class="now">การเริ่มต้นเกม</span></div>
					        <div class="page_tit">การเริ่มต้นเกม</div>
				        ...
				        <div class="content_page">
					        ...
					        <div class="con_text">
						        <ul>
							        <li>ยินดีต้อนรับเข้าสู่ TwelveSky2 WSP!<br />  You can begin by downloading the game here: TwelveSky2 WSP Download Page</li>
						        </ul>
					        </div>
					        <div class="con_img01">
						        <ul>
					        ...
					        <div class="con_text">
						        <ul>
							        <li>Your 12sky2 WSP account is required for login. You can register a free account at www.12sky2-th.com.</li>
						        </ul>
					        </div>
					        <div class="con_text">
						        <ul>
