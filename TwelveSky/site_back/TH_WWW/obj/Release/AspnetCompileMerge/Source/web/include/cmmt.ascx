                    ...
                    <table class="cmmtList" align="center">
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:TextBox ID="CNTN" runat="server" TextMode="MultiLine" Rows="5" Width="100%" Text='<%# DataBinder.Eval(Container, "DataItem.CNTN")%>'></asp:TextBox></td>
                            <td width="1">
                                <div class="btn3">
                                     <ul>
                                        <li>
...
<table class="cmmtList" align="center">
    <tr>
        <td>
            <asp:TextBox ID="CNTN" runat="server" TextMode="MultiLine" Rows="5" MaxLength="4000" Width="100%"></asp:TextBox></td>
        <td width="1">
            <div class="btn3">
                <ul>
                    <li>
