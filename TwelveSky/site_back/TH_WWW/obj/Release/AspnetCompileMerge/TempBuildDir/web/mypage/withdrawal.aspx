        ...
        <div id="main_bg">
            <div id="wrap">
        		...
        		<div id="C_container">
			        ...
			        <div class="lnb">
				        ...
				        <div class="left_menu">
					        <ul>
						        ...
						        <li><a href="/web/mypage/withdrawal.aspx" class="on">ยกเลิกการใช้งาน</a></li>
					        </ul>
				        </div>
			        </div>
			        <!-- // left menu -->
			        ...
			        <div id="contents">
				        <div class="con_top">
					        <div class="nav_hint">Home &gt; My Page &gt; <span class="now">ยกเลิกการใช้งาน</span></div>
					        <div class="page_tit">  ไม่สามารถใช้งานได้.</div>
				        </div>
