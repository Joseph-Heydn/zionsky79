<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="buffs.aspx.cs" Inherits="_12sky2.web.shop.buffs" %>
...
<%--				        <div class="left_search">
			        ...
			        <div id="contents">
				        <div class="con_top">
					        <div class="nav_hint">Home &gt; Shop &gt; รายการสินค้า &gt; <span class="now">Buffs</span></div>
					        ...
					        <div class="page_tab">
						        <div class="tab">
							        <ul>
								        ...
								        <li class="on"><a href="/web/shop/buffs.aspx">Buffs</a></li>
