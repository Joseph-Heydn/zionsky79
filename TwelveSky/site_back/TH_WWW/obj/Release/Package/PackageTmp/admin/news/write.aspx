<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="write.aspx.cs" Inherits="_12sky2.admin.news.write" %>
        ...
        <div>
            <div id="wrap">
                ...
                <div id="C_container">
                    ...
                    <div id="contents">
                    	<div class="con_top">
					        <div class="nav_hint">Home &gt; ข่าวคราว &gt; <span id="NAV_TITL" runat="server" class="now"></span></div>
                        ...
                        <script type="text/javascript">
                            function setImg(data) {
                                ...
                                if (data.imagealign) {
                                    var imageUrl = data.imageurl; console.log(seq, imageUrl);
			            ...
			            <div class="con_table">
				            <table cellspacing="0" cellpadding="0" class="N_table">
				                <tbody>
                                    ...
                                    <tr>
                                        <th><span id="fileTitle" runat="server"></span></th>
                                        <td>
                                            <div class="btn2">
                                                <ul>
