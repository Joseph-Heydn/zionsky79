...
public class SYS {
	public static string DOMAIN = "http://www.12sky2-th.com";
	public static string MAIL_SERVER = "211.119.136.241";
	public static string BILL_URL = "http://bill.12sky2-th.com";
	public static string COOKIE_DOMAIN = "12sky2-th.com";
	public static string E_MAIL_URL = "kjgames15@gmail.com";
	public static string FACEBOOK_LANG = "en_US";
	public static string FACEBOOK_URL = "https://www.facebook.com/WSP.TH/";
	public static string EXE_URL = "http://kj.edgesuite.net/TH/SETUP/WSP_TH.exe";
	...
	public static string NAT_CD = "TH";
