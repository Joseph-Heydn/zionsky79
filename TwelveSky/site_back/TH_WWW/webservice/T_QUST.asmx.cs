...
namespace _12sky2.webservice
{
    ...
    public class T_QUST : System.Web.Services.WebService
    {
        /*********************************************************************************************************************/
        /* total count
        /*********************************************************************************************************************/
...
" + ex.Message;
        ...
        public Exception insert(string USER_ID, string USER_NO, string NICK_NM, string QUST_CD_1, string QUST_CD_2
            , string TITL, string CNTN, string FILE_PATH_1, string FILE_PATH_2, string FILE_PATH_3, string FILE_PATH_4, string FILE_PATH_5
            , string NAT_CD, string SCRT_EMAIL)
        {
            string tmpSQL = null, msg = null;
