  ...
  $(document).ready(function () {    
    ...
    $("#NewConfirmPassword").live('keyup', function () {
      ...
      if ($("#NewPassword").val().length = $("#NewConfirmPassword").val().length && $("#NewPassword").val() == $("#NewConfirmPassword").val()) {
        ...
        $("#CheckMessage").show();
        $("#CheckMessage").html('Password does not match.');
        return;
      }
    });
    //패스워드 확인 체크 종료
    ...
    $("#ModifyButton").click(function () {
      if ($("#UserID").val() == "") {
        $("#CheckMessage").show();
        $("#CheckMessage").html("Please enter your E-Mail Address.");
        return;
      }
        		...
        		<div id="C_container">
			        ...
			        <div id="contents">
				        ...
				        <div class="content_page">
					        ...
					        <div class="con_text">
						        <ul>
							        <li>Please type the current password and the new password that you are willing to change.</li>
						        </ul>
					        </div>
					        <div class="profile">
