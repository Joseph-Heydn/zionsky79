<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="video.aspx.cs" Inherits="_12sky2.web.media.video" %>
        ...
        <div id="main_bg">
            <div id="wrap">
		        ...
		        <div id="C_container">
                    ...
                    <!-- left menu -->
                    <left:layout id="left" runat="server" setTITL="Media" setSUB_TITL="video" />
			
					<!-- content -->
			        <div id="contents">
				        <div class="con_top">
					        <div class="nav_hint">Home &gt; Media &gt; <span class="now">Video</span></div>
					        <div class="page_tit">Video</div>
				        </div>
