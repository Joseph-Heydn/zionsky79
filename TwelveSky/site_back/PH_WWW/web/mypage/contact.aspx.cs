...
namespace _12sky2.web.mypage {
	public partial class contact : Page {
		...
		readonly webservice.T_QUST_CD T_QUST_CD = new webservice.T_QUST_CD();
		readonly webservice.T_QUST T_QUST = new webservice.T_QUST();
...
error		: "+ err.Message
		...
		protected void btn_submit_Click(object sender, EventArgs e) {
			try {
				...
				,	Session["USER_NO"].ToString()
				,	Session["USER_NICK_NM"].ToString()
				,	QUST_CD_1.SelectedValue
				,	QUST_CD_2.SelectedValue
				,	TITL.Text
				,	CNTN.Text
				,	FILE_PATH_1.Value
				,	FILE_PATH_2.Value
