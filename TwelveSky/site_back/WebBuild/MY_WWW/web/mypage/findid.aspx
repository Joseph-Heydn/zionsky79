            ...
            <div id="wrap">
		        ...
		        <div id="C_container">
			        ...
			        <div class="lnb">
				        ...
				        <div class="left_menu">
					        <ul>
						        <li><a href="/web/mypage/findid.aspx" class="on">Find ID</a></li>
						        <li><a href="/web/mypage/findpassword.aspx">Find Password</a></li>
					        </ul>
				        </div>
			        </div>
			        <!-- // left menu -->
			        ...
			        <div id="contents">
				        <div class="con_top">
					        <div class="nav_hint">Home &gt; My Page &gt; <span class="now">Find ID</span></div>
					        <div class="page_tit">Find ID</div>
				        </div>
				        ...
				        <div class="content_page">
					        ...
					        <div class="con_text">
						        <ul>
							        <li>To find your user ID, please enter your nickname. Log-in information will be sent to your security email account.</li>
						        </ul>
					        </div>
					        <div class="profile">
