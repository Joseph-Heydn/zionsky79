			...
			<div id="C_container">
				...
				<div id="contents">
					...
					<div class="content_page">
						...
						<div class="con_text">
							<ul>
								<li><strong>Faction<asp:Literal runat="server" meta:resourcekey="lbl_conPage_02"/></strong></li>
								<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_03"/></li>
							</ul>
						</div>


						<div class="con_tit01"><asp:Literal runat="server" meta:resourcekey="lbl_conPage_04"/></div>
						...
						<div class="r_img01"><img src="/resources/images/con_img/guide/gov01.png" style="width:200px;" alt=""/></div>

						<div class="con_tit01"><asp:Literal runat="server" meta:resourcekey="lbl_conPage_09"/></div>
						<div class="con_text01">
							<ul>
								<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_10"/>
									<ul>
								...
								<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_13"/>
									<ul>
										<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_14"/></li>
									</ul>
								</li>
								<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_15"/>
									<ul>
								...
								<li><asp:Literal runat="server" meta:resourcekey="lbl_conPage_19"/>
									<ul>
						...
						<div class="con_tit01"><asp:Literal runat="server" meta:resourcekey="lbl_conPage_22"/></div>
						<div class="con_text">
							<ul>
						...
						<div class="r_img01"><img src="/resources/images/con_img/guide/gov02.png" style="width:200px;" alt=""/></div>
