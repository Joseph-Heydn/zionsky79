				...
				<div id="contents">
					<div class="con_top">
						...
						<div class="page_tit">
							...
							<asp:Literal runat="server" meta:resourcekey="lbl_Charactor_03"/>
						</div>
						...
						<div class="page_tab">
							<div class="tab">
								<ul>
									...
									<li class="on"><a href="/web/guide/jinong.aspx"><asp:Literal runat="server" meta:resourcekey="lbl_Charactor_03"/></a></li>
									<li><a href="/web/guide/nangin.aspx"><asp:Literal runat="server" meta:resourcekey="lbl_Charactor_04"/></a></li>
								</ul>
							</div>
						</div>
						<div class="con_tit02"><asp:Literal runat="server" meta:resourcekey="lbl_Charactor_03"/></div>
						<div class="con_img02">
							<ul>
