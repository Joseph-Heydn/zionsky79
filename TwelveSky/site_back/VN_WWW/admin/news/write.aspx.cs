    ...
    public partial class write : System.Web.UI.Page
    {
        ...
        protected void btn_save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                T_NOTI_BORD.insert(Request.QueryString["DIV"].ToString(), _title.Value, tmpCntn, Session["USER_ID"].ToString(), Session["USER_NICK_NM"].ToString(), "N", NAT_CD, _fileList.Value.Split(new char[] { ',' }));
