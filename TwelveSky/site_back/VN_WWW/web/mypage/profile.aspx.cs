...
namespace _12sky2.web.mypage {
	public partial class profile : Page {
		...
		private const string C_WEB_RESOURCE = "/web/mypage/profile.aspx";
		...
		protected void btn_save_Click(object sender, EventArgs e) {
			try {
				...
				SYS.Save_Log(ex.Message);
				SYS.Javascript(Page, $"alert('{fnLabelText("msgError_06")}');");
			}
		}
		...
		//	DbDataAdapter adapter = connect.Factory(ConfigurationManager.AppSettings["NAT_DATA"]).CreateDataAdapter();
			...
			try {
				...
				tmpSQL = @"
                        ...
                        VALUES
                            (" + SEQ + ", '" + RELT_DIV + "', 0,N'" + FILE_NM + "', N'" + CHNG_NM + "', '" + FILE_SIZE +
