...
<script type="text/javascript">
	...
	function fnDownload() {
		var vMessage = '<asp:Literal runat="server" meta:resourcekey="lbl_download"/>';
		alert(vMessage);
		$("#ID").focus();
	}
</script>
								...
								<ul class="input_box">
									...
									<li class="forget">
										<a href="/web/mypage/findid.aspx">
											<asp:Literal runat="server" meta:resourcekey="lbl_login"/>
										</a>
									</li>
								</ul>
								<ul class="login_btn">
									<li>
										<asp:LinkButton id="btn_login" runat="server" OnClick="btn_login_Click">
											<img src="/resources/images/img/login_btn.png" alt=""/>
										</asp:LinkButton>
									</li>
								</ul>
</asp:Panel>
<asp:Panel id="USER_PAGE" runat="server" Visible="false">
								<ul class="input_box">
									...
									<li class="logout">
										<a href="#" onclick="if(confirm('<%= fnLabelText("msg_Error_04") %>')) { __doPostBack('btn_logout',''); }">Logout</a>
								...
								<ul>
									...
									<li>
										...
										<asp:Panel id="DOWN2" runat="server" Visible="false">
											<a href="#" onclick="javascript:fnDownload();"><img src="/resources/images/img/download_btn.png" alt="game download"/></a>
										</asp:Panel>
									</li>
								</ul>
							</div>
