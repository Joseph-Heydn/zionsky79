		...
		<div id="wrap">
			...
			<div id="C_container">
				...
				<div class="lnb">
					...
					<div class="left_menu">
						<ul>
							<li><a href="/web/shop/upgrading.aspx" class="on"><%= fnLabelText("upgrading") %></a></li>
							<asp:Panel id="LEFT_MENU_LIST" runat="server" Visible="false">
							<li><a href="<%=GETBILLURL()%>"><%= fnLabelText("cash") %></a>
								<ul>
									<li><a href="<%=GETBILLURL()%>"><%= fnLabelText("coins") %></a></li>
									<li><a href="<%=GETBILLURL()%>/History/FillUpHistory.aspx"><%= fnLabelText("history") %></a></li>
									<li><a href="<%=GETBILLURL()%>/History/PurchaseHistory.aspx"><%= fnLabelText("purchase") %></a></li>
									<li><a href="<%=GETBILLURL()%>/Policy/CoinsPolicy.aspx"><%= fnLabelText("policy") %></a></li>
								</ul>
							</li>
							</asp:Panel>
						</ul>
