<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="findmessage_pw.aspx.cs" Inherits="_12sky2.web.mypage.findmessage_pw" %>
				...
				<div id="contents">
					...
					<div class="content_page">
						...
						<div class="con_text" style="background:#f5f5f5; margin-top:20px; padding:20px 10px;">
							<ul>
								<li>Mật khẩu tạm thời đã được gửi đi. Vui lòng kiểm tra Email của bạn.</li>
							</ul>
						</div>
					</div><!-- -->
