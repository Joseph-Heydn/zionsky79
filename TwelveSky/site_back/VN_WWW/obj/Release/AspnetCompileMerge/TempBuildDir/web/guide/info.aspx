				...
				<div id="contents">
					<div class="con_top">
						...
						<div class="page_tit">
							...
							<asp:Literal runat="server" meta:resourcekey="lbl_Charactor_01"/>
						</div>
					...
					<div class="content_page">
						<div class="page_tab">
							<div class="tab">
								<ul>
									<li class="on"><a href="/web/guide/info.aspx"><asp:Literal runat="server" meta:resourcekey="lbl_Charactor_01"/></a></li>
						...
						<div class="con_tit02"><asp:Literal runat="server" meta:resourcekey="lbl_Charactor_01"/></div>
						<div class="con_img02">
							<ul>
