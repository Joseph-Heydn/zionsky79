            ...
            <div id="wrap">
		        ...
		        <div id="C_container">
			        ...
			        <div class="lnb">
				        ...
				        <div class="left_menu">
					        <ul>
						        <li><a href="/web/mypage/findid.aspx">Find ID</a></li>
						        <li><a href="/web/mypage/findpassword.aspx" class="on">Find Password</a></li>
					        </ul>
				        </div>
			        </div>
			        <!-- // left menu -->         
			        ...
			        <div id="contents">
			            <div class="con_top">
					        <div class="nav_hint">Home &gt; My Page &gt; <span class="now">Find Password</span></div>
					        <div class="page_tit">Find Password</div>
				        </div>
				        ...
				        <div class="content_page">
					        ...
					        <div class="con_text">
						        <ul>
							        <li>Temporal Password will be sent to your email if you type the registered ID and Security question.</li>
						        </ul>
					        </div>
					        <div class="profile">
