    ...
    public partial class list : System.Web.UI.Page
    {
        ...
        private void getList()
        {
            try
            {
                ...
                if (result_top.Rows.Count > 0) TOP_LIST.Visible = true;
                else TOP_LIST.Visible = false;
                ...
                if (result_top5.Rows.Count > 0) TOP_5_LIST.Visible = true;
                else TOP_5_LIST.Visible = false;
