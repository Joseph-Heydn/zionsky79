        ...
        <div id="main_bg">
            <div id="wrap">
	            ...
	            <div id="C_container">
		            ...
		            <div id="contents">
			            <div class="con_top">
				            <div class="nav_hint">Home &gt; Game Guides &gt; <span class="now">NPCs</span></div>
				            <div class="page_tit">NPCs</div>
				            <div class="write_date">by <span class="writer">SUPERManager</span> 20 Aug 2013</div>
			            </div>

			            <!-- contents start -->
			            <div class="content_page">
				            <div class="con_tit">Kailan Fortress</div>
					            ...
					            <table cellspacing="0" cellpadding="0" class="C_table01" style="border-bottom:1px solid #ccc;">
						            ...
						            <tbody>
							            <tr>
								            ...
								            <td class="center">Gate master Rei <br />- Zone Travel</td>
								            <td class="center">Teleportation, Character Bank</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs03.png" alt="" /></td>
								            <td class="center">Blacksmith Hetoseh <br />- Smithy</td>
								            <td class="center">Sell Items, Purchase and enchant weapons</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs04.png" alt="" /></td>
								            <td class="center">Beggar Xiao Sun <br />- Antiquities</td>
								            <td class="center">Downgrade or Upgrade the Equipment level</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs05.png" alt="" /></td>
								            <td class="center">Agent Sang <br />- Commissioned Sales</td>
								            <td class="center">Buy or Sell items</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs06.png" alt="" /></td>
								            <td class="center">Tailor Sahn <br />- Protective Equipment</td>
								            <td class="center">Sell items, purchase and enchant protective</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs07.png" alt="" /></td>
								            <td class="center">Guard Captain Kyoku <br />- PvP Travel</td>
								            <td class="center">Purchase Health and Chi pills and Tablets, Return Scrolls, and Heavenly Fruit</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs08.png" alt="" /></td>
								            <td class="center">Herbalist Terokan </br />- Pharmaceuticals</td>
								            <td class="center">Purchase Health and Chi pills and Tablets, Return Scrolls, and Heavenly Fruit</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs09.png" alt="" /></td>
								            <td class="center">Gambler Nu <Br />- Shyster</td>
								            <td class="center">Dice Game, Nangi Track, Silver Note Exchange</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs10.png" alt="" /></td>
								            <td class="center">Guild Directer Noh <br />- Management</td>
								            <td class="center">Equipment Storage, Create/Expand a Guild</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs11.png" alt="" /></td>
								            <td class="center">Trader Aikosa <br />- Fine Goods</td>
								            <td class="center">Item Mall Vendor</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs12.png" alt="" /></td>
								            <td class="center">Bladekeeper Ro <br />- Blade Trainer</td>
								            <td class="center">Teaches Basic Balde Skills</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs13.png" alt="" /></td>
								            <td class="center">Master Brus Li <br />- Marble Trainer</td>
								            <td class="center">Teaches Basic Marble Skills</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs14.png" alt="" /></td>
								            <td class="center">Swordmaster Lupai <br />- Sword Trainer</td>
								            <td class="center">Teaches Basic Sword Skills</td>
							            </tr>
							            <tr>
								            <td class="center"><img src="/resources/images/con_img/guide/npcs15.png" alt="" /></td>
								            <td class="center">Elder Chong <br />- Palace Liason</td>
								            <td class="center">Move to Palace, Combine Archives, Stat Reset</td>
							            </tr>
						            </tbody>
					            </table>
				            </div>

				            <div class="con_tit01">Ling Chi Fortress</div>
				            ...
				            <div class="con_tit01">Ronyan Fortress</div>
