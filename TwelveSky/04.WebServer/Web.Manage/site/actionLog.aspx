<%@ Page
	...
	Inherits="Web.Manage.site.actionLog"
%>
<asp:Content ContentPlaceHolderId="cpScript" runat="server">
	...
	<script type="text/javascript">
		...
		function fnCopyDate() {
			var objStartDate = $(window.gPrefix +"txtStartDate");
			var objLimitDate = $(window.gPrefix +"txtLimitDate");
...
<asp:Content ContentPlaceHolderId="cpContents" runat="server">
	...
	<div id="content" class="col-lg-10 col-sm-10" style="margin-bottom:-15px;">
		<div class="breadcrumb">
			...
			</div>			<div style="width:170px; display:inline-block;">
			...
			<div style="width:120px; display:inline-block;">
				<asp:Button OnClick="btnSearch_Click" CssClass="btn-xs" EnableViewState="False" runat="server" meta:resourcekey="sh_btn_Search"/>
				<asp:Button OnClick="btnInit_Click" CssClass="btn-xs" EnableViewState="False" runat="server" meta:resourcekey="sh_btn_Init"/>
			</div>
		</div>
	</div>
	<!--//검색 조건 입력 패널 -->
					...
					<tr id="m<%# Eval("cLogs") %>" class="<%= fnRowStyle() %>" style="text-align:center;">
						<td>
							<asp:LinkButton CommandName="SELECT_DATE" runat="server">
								<asp:Literal id="cCreateTime" Text='<%# fnDateTime(Eval("cCreateTime")) %>' runat="server"/>
							</asp:LinkButton>
						</td>
						<td>
