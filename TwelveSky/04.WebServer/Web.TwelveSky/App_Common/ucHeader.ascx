...
<div class="header">
	<div class="logo">
		<a href="/"><img src="/_common/_images/img/12sky2_logo.png" class="png24" alt="Twelvesky2 WSP by KJ GAMES"/></a>
	</div>
...
<asp:Repeater id="repParent" OnItemDataBound="OnCategoryMenuBound" runat="server">
	<ItemTemplate>
		<div class="menu_<%= gMenuCnt++ %>">
			<h2>
				<a href="<%# Eval("[4]") %>">
					<img src="<%# fnPrintImage(Eval("[5]"), false) %>" rel="<%# fnPrintImage(Eval("[5]"), false) %>" rel2="<%# fnPrintImage(Eval("[5]"), true) %>" class="png24" alt=""/>
				</a>
			</h2>
