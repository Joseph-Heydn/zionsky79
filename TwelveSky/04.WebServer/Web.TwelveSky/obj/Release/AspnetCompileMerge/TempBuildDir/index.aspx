...
<asp:Content ContentPlaceHolderId="cpScript" runat="server">
	<script type="text/javascript" src="/_common/_js/jQuery/slides.min.jquery.js"></script>
	<script type="text/javascript" src="/_common/_js/__main.js"></script>
	...
	<script type="text/javascript">
		...
		var gObject = {
				txtAccountId	: "#<%= txtAccountId.ClientID %>"
...
<asp:Repeater id="repTopRolling" runat="server">
	<ItemTemplate>
						<li onclick="javascript:;" gametype="<%# Eval("cWriteNo") %>"<%= fnHideImage() %>>
							<p class="img"><img src="<%# fnImageUrl(Eval("cFolder"), Eval("cImage"), Eval("cExts")) %>" style="width:500px; height:320px;" alt=""/></p>
							<p class="trans"><img src="/_common/_images/us/12sky2/main/trans.png" class="png24" style="width:500px; height:320px;" alt=""/></p>
				...
				<div class="roll_btn">
					<p class="btn_pre" id="prevButton">
						<a href="javascript:moveMenu(-1);">
							<img src="/_common/_images/us/12sky2/main/event_btn_pre.jpg" alt="previous" title="previous"/>
						</a>
					</p>
					<ul>
<asp:Repeater id="repTopRollBtn" runat="server">
	<ItemTemplate>
					...
					<p class="btn_next" id="nextButton">
						<a href="javascript:moveMenu(1);">
							<img src="/_common/_images/us/12sky2/main/event_btn_next.jpg" alt="next" title="next"/>
						</a>
					</p>
				</div>
				<!-- roll_btn -->
...
<asp:Panel id="pnLoginPage" runat="server" Visible="false">
						<ul class="input_box">
							<li>
								<asp:TextBox id="txtAccountId" MaxLength="50" CssClass="int" runat="server"/>
							</li>
							<li>
								<asp:TextBox id="txtPassword" TextMode="Password" MaxLength="16" CssClass="int" runat="server"/>
							</li>
							<li class="forget">
								<a href="/web/privacy/findid.aspx?pMenu=1000018">
						...
						<ul class="login_btn">
							<li>
								<asp:LinkButton OnClientClick="return fnWebLogin();" OnClick="btnLogin_OnClick" runat="server">
...
<asp:Panel id="pnUserPage" runat="server" Visible="false">
						<ul class="input_box">
							...
							<li class="mypage">
								<a href="/web/privacy/profile.aspx?pMenu=1000018">
					...
					<div class="signup_btn">
						<ul>
							<li><a href="/web/privacy/signup.aspx"><img src="/_common/_images/img/<%= C_LANG_CODE %>/signup_btn.png" alt="signup"/></a></li>
							<li>
...
<asp:Repeater id="repAnnounce" runat="server">
	<ItemTemplate>
								<li>
									<h4>
										<a href='/web/board/view.aspx?pMenu=<%# Eval("cMenuNo") %>&pWrite=<%# Eval("cWriteNo") %>'>
											<%# Eval("cTitle") %>
										</a>
									</h4>
									<p class="date">
										...
										<%# string.Format("{0:dd MMM YYYY}", Eval("cCreateTime")) %>
									</p>
									<dl>
										<dt>
											<a href="/web/board/view.aspx?pMenu=<%# Eval("cMenuNo") %>&pWrite=<%# Eval("cWriteNo") %>">
												<img src="/FileUp/<%# Eval("cFolder") %>/<%# Eval("cMainImage") %>_m.<%# Eval("cFileExt") %>" alt=""/>
											</a>
										</dt>
										<dd>
											<a href="/web/board/view.aspx?pMenu=<%# Eval("cMenuNo") %>&pWrite=<%# Eval("cWriteNo") %>">
								...
								<ul>
									<li>
										<a href='<%= C_FACEBOOK_URL %>' target="_blank">
											<img src="/_common/_images/us/12sky2/main/sns_facebook.jpg" alt="facebook" title="facebook"/>
										</a>
									</li>
								</ul>
							</div>
