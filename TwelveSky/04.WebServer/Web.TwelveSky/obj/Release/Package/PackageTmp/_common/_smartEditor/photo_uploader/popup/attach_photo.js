    ...
    function html5Upload() {
	    ...
	    var sUploadURL= "/_common/_smartEditor/photo_uploader/popup/file_uploader_html5.aspx"; 	//upload URL
    	//파일을 하나씩 보내고, 결과를 받음.
    ...
    function makeArrayFromString(sResString){
    	var	aTemp = [],
 		...
 		var aResultleng = aResult.length;
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.aspx',	//샘플 URL입니다.
