<%@ Page
	...
	CodeBehind="findId.aspx.cs"
	Inherits="Web.TwelveSky.web.guest.findId"
%>
<%@ Register
...
<asp:Content ContentPlaceHolderId="cpContents" runat="server">
	<div id="contents">
		...
		<div class="content_page">
					...
					<table class="C_table01" style="border-spacing:0; padding:0;">
						...
						<tbody>
							<tr>
								...
								<td>
									<asp:TextBox id="txtNickname" runat="server" Width="240"/>
								</td>
							</tr>
						</tbody>
					</table>
			...
			<p class="t_center">
				<span id="ModifyButton" class="btn_type">
					<asp:LinkButton OnClientClick="return fnCheckForm();" OnClick="btnFindAccount_Click" runat="server" meta:resourcekey="lblFindIdent"/>
				</span>
			</p>
		</div>
		<!-- content_page -->
