<%@ Page
	...
	Inherits="Web.TwelveSky.web.privacy.withdraw"
%>
<%@ Register
...
<asp:Content ContentPlaceHolderId="cpScript" runat="server">
	<script type="text/javascript">
		...
		function fnCheckForm() {
			...
			if ( !confirm(gMessage.Alert_01) ) {
				return false;
			}
			if ( txtAccountId.val().length < 10 ) {
				alert(gMessage.Alert_03);
				txtAccountId.focus();
				return false;
			}
			if ( txtPassword.val().length < 6 ) {
				alert(gMessage.Alert_04);
				txtPassword.focus();
				return false;
			}
...
<asp:Content ContentPlaceHolderId="cpContents" runat="server">
	<div id="contents">
		...
		<div class="content_page">
			...
			<p class="t_center">
				<span class="btn_type">
					<asp:LinkButton OnClientClick="return fnCheckForm();" OnClick="btnDeactivate_Click" runat="server" meta:resourcekey="btnConfirm"/>
				</span>
			</p>
		</div>
		<!-- content_page -->
